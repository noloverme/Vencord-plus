...
export const ruPlugins: Record<string, RuPluginStrings> = {
    ...
    BetterFolders: {
        d: "Показывает папки серверов на отдельной панели и улучшает работу с папками",
        o: {
            closeServerFolder: { d: "Закрывать папку при выборе сервера из неё" },
        },
    },
    ...
    TypingIndicator: {
        d: "Индикатор печатающих на канале",
        o: {
            includeIgnoredUsers: { d: "Показывать ли индикатор печати игнорируемых пользователей" },
        },
    },
    ...
    WhoReacted: {
        d: "Аватары отреагировавших на сообщение",
        o: {
            clickableAvatars: { d: "Пока включено, клик по аватару отреагировавшего открывает профиль вместо добавления реакции" },
        },
    },
    ...
    // ---- upstream v1.15.5 ----
    AddAttachments: { d: "Позволяет добавлять вложения при редактировании сообщений" },
